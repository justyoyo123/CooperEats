  ...
  const CartPage = () => {
    ...
    // };
      const handleAddItemQuantity = async (foodId) => {
          ...
          try {
              const stockResponse = await axios.get(`http://20.88.180.242:8080/api/foods/${foodId}`);
    ...
    const handleClearCart = async () => {
        ...
        try {
            ...
            const response = await axios.delete(`http://20.88.180.242:8080/api/carts/${userId}`);
